...
Portolan conformance is defined by passing this validator. reis currently implements the **metadata validation pass**: every requirement in the [Portolan spec](https://github.com/portolan-sdi/portolan-spec) checkable from the catalog's JSON metadata alone, without reading asset bytes.

Not covered here (separate passes):

- STAC 1.1.0 structural validation (delegate to `stac-validator`)
...
| `PTL-FIL` | 001–002 | AGENTS.md and README.md on disk, `rel:"agents"` markdown link |
